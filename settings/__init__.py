...
# DOCUMENTS_PATH = os.path.join(os.environ.get(
#     'HOMEDRIVE'), os.environ.get('HOMEPATH'), 'Documents')
...
#         self.internal_dict['DUMMY_FILE'] = os.path.join(
#             self.internal_dict['DATA_FOLDERS'][0], 'dummy.csv')
...
class Configuration:
    def __init__(self):
        from utils.module_loader import get_module_by_name

        self._config = OrderedDict()
        
        module = get_module_by_name('zemailer.settings.base')
